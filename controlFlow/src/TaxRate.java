...
*/
        ...
        switch (num) {
            ...
            case 1:
                ...
                {
                    paytax = income * Rate.TEN.getValue();
                }else if(income>=8351 && income<=33950)
                {
                    paytax = income * Rate.FIFTEEN.getValue();
                }else if(income>=33951 && income<=82250)
                {
                    paytax = income * Rate.TWENTYFIVE.getValue();
                }else if(income>=82251 && income<=171550)
                {
                    paytax = income * Rate.TWENTYEIGHT.getValue();
                }else if(income>=171551 && income<=372950)
                {
                    paytax = income * Rate.THIRTYTHREE.getValue();
                }else if(income>=372951)
                {
                    paytax = income * Rate.THIRTYFIVE.getValue();
                }
                break;
            case 2:
                ...
                {
                    paytax = married_income * Rate.TEN.getValue();
                }else if(married_income>=16701 && married_income<=67900)
                {
                    paytax = married_income * Rate.FIFTEEN.getValue();
                }else if(married_income>=67901 && married_income<=137050)
                {
                    paytax = married_income * Rate.TWENTYFIVE.getValue();
                }else if(married_income>=137051 && married_income<=208850)
                {
                    paytax = married_income * Rate.TWENTYEIGHT.getValue();
                }else if(married_income>=208851 && married_income<=372950)
                {
                    paytax = married_income * Rate.THIRTYTHREE.getValue();
                }else if(married_income>=372951)
                {
                    paytax = married_income * Rate.THIRTYFIVE.getValue();
                }
                break;
            case 3:
                ...
                {
                    paytax = married_sep_income * Rate.TEN.getValue();
                }else if(married_sep_income>=8351 && married_sep_income<=33950)
                {
                    paytax = married_sep_income * Rate.FIFTEEN.getValue();
                }else if(married_sep_income>=33951 && married_sep_income<=68525)
                {
                    paytax = married_sep_income * Rate.TWENTYFIVE.getValue();
                }else if(married_sep_income>=68526 && married_sep_income<=104425)
                {
                    paytax = married_sep_income * Rate.TWENTYEIGHT.getValue();
                }else if(married_sep_income>=104426 && married_sep_income<=186475)
                {
                    paytax = married_sep_income * Rate.THIRTYTHREE.getValue();
                }else if(married_sep_income>=186476)
                {
                    paytax = married_sep_income * Rate.THIRTYFIVE.getValue();
                }
                break;
            case 4:
                ...
                {
                    paytax = hoh_income * Rate.TEN.getValue();
                }else if(hoh_income>=11951 && hoh_income<=45550)
                {
                    paytax = hoh_income * Rate.FIFTEEN.getValue();
                }else if(hoh_income>=45501 && hoh_income<=117450)
                {
                    paytax = hoh_income * Rate.TWENTYFIVE.getValue();
                }else if(hoh_income>=117451 && hoh_income<=190200)
                {
                    paytax = hoh_income * Rate.TWENTYEIGHT.getValue();
                }else if(hoh_income>=190201 && hoh_income<=372950)
                {
                    paytax = hoh_income * Rate.THIRTYTHREE.getValue();
                }else if(hoh_income>=372951)
                {
                    paytax = hoh_income * Rate.THIRTYFIVE.getValue();
                }else
                {
